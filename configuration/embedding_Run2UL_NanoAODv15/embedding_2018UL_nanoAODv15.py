...
# with command line options: RECO --step NANO:@TauEmbedding --scenario pp --data --era Run2_2018,run2_nanoAOD_106Xv2 --conditions 150X_dataRun2_v1 --datatier NANOAODSIM --eventcontent NANOAOD --nThreads 2 --number 10 --filein file:MuTauEmbedding-UL2018C_MiniAODv2.root --fileout file:ReReco-MuTauEmbedding-UL2018_NanoAODv15.root --python_filename ReReco-Run2018C-TauEmbedding-UL2018_NanoAODv15_cfg.py --no_exec --customise_commands process.unpackedPatTrigger.triggerResults = cms.InputTag("TriggerResults::SIMembeddingHLT");\
...
process.configurationMetadata = cms.untracked.PSet(
    annotation=cms.untracked.string("nano"),
